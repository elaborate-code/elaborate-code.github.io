...
<div class="w-[360px] h-[480px] py-8 px-1 project-card">
    <div
        ...
        <p
            class="absolute -bottom-12 left-6 w-[300px] p-4 bg-inherit shadow-lg rounded-3xl hover:text-black hover:shadow-xl">
            {{ $project->desc }}
        </p>
    </div>
</div>
